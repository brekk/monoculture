...
### Usage
```js,    import { fork } from 'fluture',    import { readFile } from 'file-system',    fork(console.warn)(console.log)(,      readFileWithFormatAndCancel(() => process.exit(), 'utf8', './README.md'),    ),```
...
### Usage
```js,    import { fork } from 'fluture',    import { readFile } from 'file-system',    fork(console.warn)(console.log)(,      readFileWithCancel(() => process.exit(), './README.md'),    ),```
...
### Usage
```js,    import { fork } from 'fluture',    import { readFile } from 'file-system',    fork(console.warn)(console.log)(readFile('./README.md')),```
...
Read a glob asynchronously as a Future-wrapped value, with configuration and a cancellation function. Configuration is passed to [glob](https://www.npmjs.com/package/glob)
...
Read a glob asynchronously as a Future-wrapped value, with configuration. Configuration is passed to [glob](https://www.npmjs.com/package/glob)
...
Read a glob asynchronously as a Future-wrapped value, default config assumed. Configuration is passed to [glob](https://www.npmjs.com/package/glob)
...
### Usage
```js,     import { fork } from 'fluture',     import { removeFileWithConfigAndCancel } from 'file-system',     fork(console.warn)(console.log)(,       removeFileWithConfigAndCancel(,         cancellationFn,,         { ...fs.removeFileConfig },,         'my-file.txt',       ),     ),```
...
### Usage
```js,    import { fork } from 'fluture',    import { removeFileWithConfig } from 'file-system',    // [...],    fork(console.warn)(console.log)(,      removeFileWithConfig(,        { ...fs.removeFileConfig },,        'my-file.txt',      ),    ),```
...
### Usage
```js,    import { fork } from 'fluture',    import { removeFile } from 'file-system',    // [...],    fork(console.warn)(console.log)(,      removeFile(,        'my-file.txt',      ),    ),```
