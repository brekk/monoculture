...
export const disclosable = curry(function _disclosable(indent, title, content) {
...
export const renderReadme = curry(
  function _renderReadme(repo, showDeps, pagesURL, raw) {
    return pipe(
      toPairs,
      map(([group, list]) =>
        pipe(
